...
const TRANSLATIONS = {
  "en": {
    ...
    "price_2_desc": "Deep cleaning of surfaces, furniture, and appliances—both inside and out. We will move everything we can and reach into every hidden nook and cranny.",
    "price_3_title": "Post-Renovation Cleaning",
    "price_3_desc": "Includes deep cleaning of all affected surfaces. Particular attention is paid to construction dust and paint stains.",
    ...
    "price_5_desc": "Keep your office or salon space spotless. We provide deep, hygienic cleaning for high-traffic areas where cleanliness matters most.",
    "price_5_includes": " ",
  ...
  "pl": {
    ...
    "price_2_desc": "Gruntowne czyszczenie powierzchni, mebli oraz sprzętów – zarówno z zewnątrz, jak i wewnątrz. Przesuniemy wszystko, co możliwe, i dotrzemy do każdego ukrytego zakamarka.",
    "price_3_title": "Sprzątanie po Remoncie",
    "price_3_desc": "Obejmuje gruntowne czyszczenie wszystkich dotkniętych zabrudzeniami powierzchni. Szczególną uwagę zwraca się na pył budowlany i ślady farby.",
    ...
    "price_5_desc": "Zadbaj o higienę w biurze lub salonie. Zapewniamy profesjonalne sprzątanie miejsc o dużym natężeniu ruchu, gdzie czystość to podstawa.",
    "price_5_includes": " ",
  ...
  "ru": {
    ...
    "price_2_desc": "Интенсивная чистка поверхностей, мебели и техники, внутри и снаружи. Мы отодвинем все что сможем и дотянемся до всех тайных закутков.",
    "price_3_title": "Уборка После Ремонта",
    "price_3_desc": "Включает глубокую очистку всех затронутых поверхностей. Основное внимание уделяется  строительной пыли и пятнам краски.",
    ...
    "price_5_desc": "Безупречная чистота для офисов и салонов. Мы обеспечиваем высокий стандарт гигиены в помещениях с большой проходимостью.",
    "price_5_includes": " ",
